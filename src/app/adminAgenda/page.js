      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="flex gap-4 mt-4 w-full">
            <div className="bg-black p-4 rounded-xl shadow-md border border-dark-300 w-full h-40"></div>
            <div className="bg-white p-4 rounded-xl shadow-md border border-gray-300 w-full h-40"></div>
          </div>
        </div>

        {/* Right Side - Agenda */}
        <div className="w-full lg:w-1/2 bg-white p-6 rounded-xl shadow-lg border border-gray-300 flex flex-col">
          <h2 className="text-xl font-bold text-black mb-4 text-center">Agenda</h2>
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[600px] border-collapse border border-gray-300 text-black">
              <thead>
          ...
          {selectedSchedule && (
            <div className="fixed top-10 right-10 bg-white p-4 border shadow-lg rounded-md w-64 animate-fade-in z-50">
