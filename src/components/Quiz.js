    ...
    <div className="w-full bg-white p-6 rounded-lg shadow-md">
      ...
      {submitted ? (
        <div className="text-center">
          ...
          <p className="text-lg mt-2">Your score: {score}/{quiz.length}</p>
        </div>
      ) : (
        <>
          {quiz.map((question) => (
          ...
          <div className="flex justify-between mt-4">
            <button
              ...
              className="bg-[#A70000] text-white px-4 py-2 rounded hover:bg-[#8a0000] disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
              Submit Quiz
            </button>
          </div>
